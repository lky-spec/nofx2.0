...
func exchangeConfigFieldsSchema() map[string]any {
	return map[string]any{
		...
		"aster_user":                  map[string]any{"type": "string", "description": "Aster main wallet address, not a username."},
		"aster_signer":                map[string]any{"type": "string", "description": "Aster API Pro wallet address."},
		"aster_private_key":           map[string]any{"type": "string", "description": "Aster API Pro wallet private key used locally for signing."},
